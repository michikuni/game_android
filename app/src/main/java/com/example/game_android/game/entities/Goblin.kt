...
class Goblin(
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    private enum class Anim { IDLE, WALK, ATTACK, HURT, DEATH }
    ...
    private val strips: Map<Anim, Strip> = mapOf(
        Anim.IDLE to loadStrip(R.drawable.goblin_idle, 13, loop = true),
        Anim.WALK to loadStrip(R.drawable.goblin_walk, 11, loop = true),
        Anim.ATTACK to loadStrip(R.drawable.goblin_attack, 7, loop = false),
        Anim.HURT to loadStrip(R.drawable.goblin_hurt, 20, loop = false),
        Anim.DEATH to loadStrip(R.drawable.goblin_death, 9, loop = false),
    )
    ...
    private var anim = com.example.game_android.game.entities.Goblin.Anim.IDLE
    private var frame = 0
    private var tick = 0
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    init {
        val ref = strips[com.example.game_android.game.entities.Goblin.Anim.IDLE]!!
